...
def Generate():
    ...
    drawData(data, ['red' for x in range(len(data))]) #['red','red' the array will contain all red
...
speedScale = Scale(UI_frame, from_=0.1,to=2.0, length=200, digit= 2, resolution=0.2, orient=HORIZONTAL, label="Select Speed [s]" )
